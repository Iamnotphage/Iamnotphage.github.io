...
# 展示
![碰撞测试](https://img-blog.csdnimg.cn/7ea60aea7a6242babbf483e86f0d8e46.gif#pic_center)
![循迹测试](https://img-blog.csdnimg.cn/da6f11ea787843ee9453b067a7d602b6.gif#pic_center)
# 一、总体功能描述
## 1.1 驱动
...
## 2.1 TI-RLSK驱动基本功能设计
### （1）驱动基本功能设计图
 ![驱动基本功能设计图](https://img-blog.csdnimg.cn/912bd72eb0874f179d6c2e39cdfb68ba.png#pic_center)

### （2）驱动基本功能设计思路
根据电机驱动模块的引脚与真值表，由**P1.6/P1.7**控制电机转向，**P2.7/P2.6**控制电机的启动，利用直接赋予高低电平的语句实现功能
 ![电机驱动模块](https://img-blog.csdnimg.cn/57653a7dc97e4533ac8487da5aa28997.png#pic_center)

据此思路实现了驱动的所有情况的功能，并将以上所有底层和封装函数，做成.h文件放在工程中便于主函数调用。
## 2.2 TI-RLSK行走碰撞功能设计
### （1）碰撞功能设计流程图
 ![碰撞功能程序流程图](https://img-blog.csdnimg.cn/ebd1f88293544491830f38ec839bfd1e.png#pic_center)
### （2）碰撞功能设计思路
![碰撞开关模块](https://img-blog.csdnimg.cn/a1d77b0ea4fc44658fb9b72cb97d92f7.png#pic_center)
